  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <input placeholder="请输入你的手机号码" v-model="phone" name="phone" v-validate="{ required: true, regex: /^1\d{10}$/ }" :class="{ invalid: errors.has('phone') }"/>
      ...
      <div class="controls" style="display: flex; justify-content: center; align-items: center;">
        <input style="margin-right: 5px;" type="checkbox" v-model="agree" name="agree" v-validate="{ required: true, 'agree': true }" :class="{ invalid: errors.has('agree') }"/>
