  ...
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" @change="updateChecked(cart.skuId, $event)" :checked="cart.isChecked" name="chk_list">
          </li>
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input :disabled="cartInfoList.length === 0" :checked="isAllCheck" @change="allSelect" class="chooseAll" type="checkbox">
        <span>全选</span>
      </div>
      <div class="option">
    ...
    methods: {
      ...
      async updateChecked(skuId, event) {
        try {
          ...
          await this.$store.dispatch('updateCheckedById', { skuId, checked })
          this.getData()
        } catch(error) {
          console.log(error)
        }
      ...
      allSelect(e) {
        // if (this.cartInfoList.length === 0) return e.target.checked = false
        // console.log(e.target.checked)
        const checked = e.target.checked ? 1 : 0
        this.cartInfoList.forEach(item => {
          item.isChecked !== checked ? this.updateChecked(item.skuId, e) : ''
        })
      },
